...
export class FeedService {
  ...
  getProducts(){
    return this.http.get(`https://887dorwc.api.sanity.io/v2021-10-21/data/query/production?query=*[_type=="product"]{title, slug, defaultProductVariant, tags, "categoryTitles": categories[]->title, "statusTitles": statuses[]->title, "vendor": vendor->title, body,} | order(createdAt asc)`, {
      headers: {
